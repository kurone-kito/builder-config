...
CodeRabbit reviewing pull requests. `GEMINI.md` exists so Gemini CLI
can still receive the minimum project rules immediately, without
...
cross-agent entry path and phase routing (Antigravity CLI, formerly
Gemini CLI).
