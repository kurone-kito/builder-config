...
The numeric `<!-- builder-config-autopilot-suitability: N -->`
...
`<!-- builder-config-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- builder-config-triage-verdict: <outcome> -->
```
...
`builder-config-triage-verdict` marker. Apply the same
