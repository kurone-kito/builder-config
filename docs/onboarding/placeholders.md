...
| -------------------------------- | --------------------------------------------------------- | ---------------------------------- |
| `builder-config` | Repository short name used in worktree examples | `my-app` |
| `builder-config` | Hidden issue-body marker prefix | `my-app` |
...
| `pnpm run lint && pnpm run build && pnpm run test` | Non-mutating verify command row | `npm run lint && npm run test` |
...
`builder-config` appears in two hidden issue-body markers:

- roadmap identity marker:
  `<!-- builder-config-roadmap-id: {unique-id} -->`
- blocked-by marker:
  `<!-- builder-config-blocked-by: {roadmap-id} -->`
