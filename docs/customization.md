...
| ------------------------------------------------------------------- | ----------------------------------------------------- |
| `idd-skill` in repo-name contexts                                   | `builder-config`                                      |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `builder-config`                                      |
| **fix-validate** command string                                     | `pnpm run lint:fix && pnpm run lint`                  |
| **pre-push-validate** command string                                | `pnpm run lint && pnpm run build && pnpm run test`    |
| **post-fix-validate** command string                                | `pnpm run lint:fix && pnpm run lint && pnpm run test` |
| **install-deps** command string                                     | `pnpm install --frozen-lockfile`                      |
...
- `audit-docs.mjs` enforces synchronization rules defined in
  `sync-manifest.json`
- Template copies use placeholders like `builder-config` to support
