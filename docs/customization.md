...
| Worktree guard base-branch refusal  | Absent or `false` (default) — the local git hook still allows a commit directly on `{development-branch}` in the primary worktree, matching the historical worktree-guard scope                                                                                                                                                                                                                                                                                                                                           | Set `worktreeGuard.refuseBaseBranchCommits: true` in `.github/idd/config.json` (`worktreeGuard.enabled` must also be `true`) to make the generated hook refuse a commit on `{development-branch}` in the primary worktree too, not only an `issue/*` / `roadmap-audit/*` implementation branch. Requires `developmentBranch` (or the repository default branch) to be resolvable; the guard leaves base-branch commits allowed if it cannot resolve one. Regenerate the hook after changing this value.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
